...
class Llama:
    ...
    def build(
        ...
        checkpoint = torch.load(ckpt_path, map_location="cpu")  # parallel loading to cpu
        ...
        torch.set_default_tensor_type(torch.cuda.HalfTensor)  # FP16
        # torch.set_default_tensor_type(torch.cuda.FloatTensor)  # FP32
